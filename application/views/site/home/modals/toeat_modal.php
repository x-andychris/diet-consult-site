<!-- Modal -->
<div class="modal fade" id="toEatModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content" style="background-color: #f9f9fd; border: none">
            <div class="modal-header" style="background: linear-gradient(to right, #244cfd, #15e4fd);">
                <h4 class="modal-title" style=" color: #fff; font-weight: bold">
                    <?php echo $page_title; ?> - (<span style="font-size: 14px; color: #fff">To Eat</span>)
                </h4>
                ...
                <div class="form-group">
                    <div class="input-group-icon ">
                        ...
                        <input type="text" class="single-input form-control" placeholder="Search"
                            style="background-color: white" id="toEatTableSearchBox">
                    </div>
                </div>
                <table cellspacing="0" id="toEatTable">
...
$(document).ready(function() {
    $("#toEatTableSearchBox").on("keyup", function() {
        var value = $(this).val().toLowerCase();
        $("#toEatTable .filter").filter(function() {
