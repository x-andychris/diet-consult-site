...
class shoppinglist_model extends CI_model {
    ...
    public function get_all(){
        $query = $this -> db-> query("select * from shoppinglist");
	...
	public function get_info($id){
        $query = $this -> db-> query("select * from shoppinglist where item_id = '$id'");
	...
	public function get_single_by($column, $value){
        $query = $this -> db-> query("select * from shoppinglist where $column = '$value'");
    ...
    public function delete($id){
        ...
        if($this -> db -> delete("shoppinglist","item_id =".$id)){
            return true;
        }
    }
    ...
    public function delete_by($column, $value){
        // if statement to handle delete success
        if($this -> db -> delete("shoppinglist","" . $column . "=" . $value)){
            return true;
        }
    }
    ...
    public function update($id, $data){
        ...
        // actual update
        if($this -> db -> update("shoppinglist",$data)){
            return true;
        }
    }
