...
class liquids_model extends CI_model {
	...
	public function get_info($id){
        $query = $this -> db-> query("select * from liquids where liquid_id = '$id'");
	...
	public function get_single_by($column, $value){
        $query = $this -> db-> query("select * from liquids where $column = '$value'");
    ...
    public function add($data){
        try{
            ...
            if($this -> db -> insert("liquids",$data)){
    ...
    public function delete($id){
        ...
        if($this -> db -> delete("liquids","liquid_id =".$id)){
            return true;
        }
    }
    ...
    public function delete_by($column, $value){
        // if statement to handle delete success
        if($this -> db -> delete("liquids","" . $column . "=" . $value)){
            return true;
        }
    }
    ...
    public function update($id, $data){
        ...
        $this -> db -> where("liquid_id",$id);

        // actual update
        if($this -> db -> update("liquids",$data)){
            return true;
        }
    }
