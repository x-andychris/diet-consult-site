...
class snacks_model extends CI_model {
    ...
    public function get_all(){
        $query = $this -> db-> query("select * from snacks");
	...
	public function get_info($id){
        $query = $this -> db-> query("select * from snacks where snack_id = '$id'");
	...
	public function get_single_by($column, $value){
        $query = $this -> db-> query("select * from snacks where $column = '$value'");
    ...
    public function delete($id){
        ...
        if($this -> db -> delete("snacks","snack_id =".$id)){
            return true;
        }
    }
    ...
    public function delete_by($column, $value){
        // if statement to handle delete success
        if($this -> db -> delete("snacks","" . $column . "=" . $value)){
            return true;
        }
    }
    ...
    public function update($id, $data){
        ...
        $this -> db -> where("snack_id",$id);

        // actual update
        if($this -> db -> update("snacks",$data)){
            return true;
        }
    }
