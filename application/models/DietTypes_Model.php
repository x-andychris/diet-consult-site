...
class diettypes_model extends CI_model {
	...
	public function get_info($id){
        $query = $this -> db-> query("select * from diet_types where diet_type_id = '$id'");
	...
	public function get_single_by($column, $value){
        $query = $this -> db-> query("select * from diet_types where $column = '$value'");
    ...
    public function add($data){
        try{
            ...
            if($this -> db -> insert("diet_types",$data)){
    ...
    public function delete($id){
        ...
        if($this -> db -> delete("diet_types","diet_type_id =".$id)){
            return true;
        }
    }
    ...
    public function delete_by($column, $value){
        // if statement to handle delete success
        if($this -> db -> delete("diet_types","" . $column . "=" . $value)){
            return true;
        }
    }
    ...
    public function update($id, $data){
        ...
        $this -> db -> where("diet_type_id",$id);

        // actual update
        if($this -> db -> update("diet_types",$data)){
            return true;
        }
    }
